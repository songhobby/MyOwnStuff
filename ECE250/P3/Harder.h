...
bool Search_tree<Type>::Node::insert( Type const &obj, Search_tree<Type>::Node *&to_this ) {
	if ( obj < node_value ) {
		if ( left_tree == nullptr ) {
			...
			// FIXME
			// This cannot cause an AVL rotation
		...
		if ( right_tree == nullptr ) {
			...
			if ( right_tree->insert( obj, right_tree ) ) {
				// FIXME
				if ( right_tree->height() - left_tree->height() == 2 ) {
					if ( obj > right_tree->node_value ) {
						/////////////////////////////
						// A right-right insertion //
						/////////////////////////////
			...
			if ( left_tree->erase( obj, left_tree ) ) {
				...
				if ( right_tree->height() - left_tree->height() == 2 ) {
					if ( right_tree->right_tree->height() > right_tree->left_tree->height() ) {
						///////////////////////////////////////////
						// Equivalent to a right-right insertion //
						///////////////////////////////////////////
						...
						///////////////////////////////////////////
						// Equivalent to a right-left insertion //
						///////////////////////////////////////////
			...
			if ( right_tree->erase( obj, right_tree ) ) {
				if ( left_tree->height() - right_tree->height() == 2 ) {
					if ( left_tree->left_tree->height() > left_tree->right_tree->height() ) {
						/////////////////////////////////////////
						// Equivalent to a left-left insertion //
						/////////////////////////////////////////
						...
						//////////////////////////////////////////
						// Equivalent to a left-right insertion //
						//////////////////////////////////////////
